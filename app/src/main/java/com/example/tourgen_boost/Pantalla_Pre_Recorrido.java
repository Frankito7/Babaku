...
public class Pantalla_Pre_Recorrido extends AppCompatActivity {
    ...
    private static final UUID mUUID = UUID.fromString("3783c582-f200-11ea-adc1-0242ac120002");  // UUID de la netbook
    ...
    protected void onResume() {
        ...
        try {
            ...
            mmSocket = device.createInsecureRfcommSocketToServiceRecord(mUUID);    // Intento establecer una comunicación con el dispositivo anteriormente obtenido
            BluetoothAdapter.getDefaultAdapter().cancelDiscovery();  // Cancelo la búsqueda de dispositivos
        } catch (IOException e) {
            e.printStackTrace();
